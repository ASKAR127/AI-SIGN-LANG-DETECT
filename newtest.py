...
labels_and_audio = {
    0: {"label": "Hello", "audio_path": r"D:\hellota.mp3"},
    1: {"label": "Love you", "audio_path": r"D:\i love you ta.mp3"},
    2: {"label": "No", "audio_path": r"D:\No ta.mp3"},
    3: {"label": "Okay", "audio_path": r"D:\okay ta.mp3"},
    4: {"label": "Please", "audio_path": r"D:\please ta.mp3"},
    5: {"label": "Thank you", "audio_path": r"D:\thank you ta.mp3"},
    6: {"label": "Yes", "audio_path": r"D:\yesta.mp3"}
}

# Load the Keras CNN model
cnn_model = tf.keras.models.load_model("D:\keras_model.h5")
